...
return [
    ...
    */
    ...
    "attributes" => [
        ...
        "acronym"                       => "Acronyme",
        "carrier_id"                    => "ID",
        "carrier.first_name"            => "Prénom",
        "carrier.last_name"             => "Nom",
        "carrier.email"                 => "Email",
        "carrier.phone"                 => "Téléphone",
        "carrier.status"                => "Statut",
        "laboratories"                  => "Laboratoires",
        "laboratories.*.id"             => "ID Laboratoire",
        "laboratories.*.name"           => "Nom du Laboratoire",
        "laboratories.*.unit_code"      => "Code unité du Laboratoire",
        "laboratories.*.director_email" => "Email du directeur du Laboratoire",
        "laboratories.*.contact_name"   => "Nom du contact au Laboratoire",
        "laboratories.*.regency"        => "Tutelle du Laboratoire",
        "duration"                      => "Durée",
        "target_date"                   => "Date(s) prévisionnelle(s)",
        "target_date.*"                 => "Date(s) prévisionnelle(s)",
        "study_fields"                  => "Champ(s) disciplinaire(s)",
        "study_fields.*.id"             => "Champ(s) disciplinaire(s)",
        ...
        "other_fundings"                => "Co-financements",
        "total_expected_income"         => "Budget prévisionnel (recettes)",
        "total_expected_outcome"        => "Budget prévisionnel (dépenses)",
        "files"                         => "Pièces complémentaires",
        "files.*.id"                    => "Pièces complémentaires",
        "files.*.order"                 => "Pièces complémentaires",
    ],
