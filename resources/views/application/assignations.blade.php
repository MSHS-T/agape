        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    @endif
                    @if(is_null($offer->accepted))
                    <a href="{{ route('offer.destroy', ['offer' => $offer]) }}"
                        class="btn btn-sm btn-danger btn-block delete-link">
...
@if($application->projectcall->canEvaluate() && $total < $application->projectcall->number_of_experts)
    ...
    @endif
    @include('partials.back_button', ['url' => route('projectcall.applications', ['projectcall' =>
    $application->projectcall->id])])
