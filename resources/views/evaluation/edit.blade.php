    ...
    <div id="accordion">
        <div class="card border-0">
            <div class="card-header border-bottom-0" id="evaluationCallTitle">
                <h4 class="mb-0">
                    <button class="btn btn-info collapsed" data-toggle="collapse" data-target="#evaluationCall" aria-expanded="false"
                        aria-controls="evaluationCall">
        ...
        <div class="card border-0">
            <div class="card-header border-bottom-0" id="evaluationApplicationTitle">
                <h4 class="mb-0">
                    <button class="btn btn-info collapsed" data-toggle="collapse" data-target="#evaluationApplication" aria-expanded="false"
                        aria-controls="evaluationApplication">
                        <span class="collapsible-icon text-muted mr-2">
                            <span class="d-inline">@svg('solid/plus')</span>
                            <span class="d-none">@svg('solid/minus')</span>
                        </span>
                    ...
                    <form method="POST" action="{{ route('evaluation.update', ['evaluation' => $evaluation]) }}" id="evaluation_form">
                                ...
                                <div class="col-9">
                                    @foreach (range(0, 3) as $grade)
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="grade{{ $iteration }}"
                                                id="grade{{ $iteration }}_{{ $grade }}" value="{{ $grade }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                @foreach (range(0, 3) as $grade)
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="global_grade" id="global_grade_{{ $grade }}"
                                            value="{{ $grade }}" @if (old('global_grade', $evaluation->global_grade) === $grade) checked @endif>
