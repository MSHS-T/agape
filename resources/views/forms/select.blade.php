...
<div class="form-group row">
    ...
    <div class="col-9">
        <div class="row">
            <div class="col">
                <select class="form-control chosen-select" id="{{$id}}" name="{{$name}}" @if($multiple) multiple @endif
                    ...
                    @endphp
                    <option value="{{ $valueVal }}" @if(in_array($valueVal, $value)) selected @endif>{{ $displayVal }}
                    </option>
                    @endforeach
                </select>
                @if(isset($help))
