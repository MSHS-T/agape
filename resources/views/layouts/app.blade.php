                                ...
                                @case(\App\Enums\UserRole::Admin)
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                            <a class="dropdown-item" href="{{ route('projectcalltype.index') }}">
                                                {{ __('actions.call_types') }}
                                            </a>
                            ...
                            @if ($errors->any())
                                @foreach ($errors->all() as $error)
                                    <div class="alert alert-dismissible fade show alert-danger" role="alert">
                                        ...
                                        <button type="button" class="close" data-dismiss="alert" aria-label="{{ __('actions.close') }}">
        ...
        <footer class="footer">
            <div class="container text-center">
                <span class="text-muted">
                    &copy; {{ config('app.name') }} 2018-{{ date('Y') }} - <a href="{{ route('contact') }}">{{ __('actions.contact') }}</a> - <a
                        href="{{ route('legal') }}">{{ __('actions.legal') }}</a>
                    <br />
                    {!! __('actions.credits') !!}
                </span>
            </div>
