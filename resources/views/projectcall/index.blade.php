            ...
            <tbody>
                ...
                @foreach ($projectcalls as $call)
                    ...
                    <tr>
                        ...
                        <td>{{ $call->type->label_short }}</td>
                        <td class="text-center">{{ $call->year }}</td>
                        <td>{{ $call->title }}</td>
                        <td class="text-center" data-search="{{ __('fields.projectcall.states.' . $call->state) }}" data-toggle="tooltip"
                            data-placement="right" title="{{ __('fields.projectcall.states.' . $call->state) }}">
                            @switch($call->state)
                                @case('open')
