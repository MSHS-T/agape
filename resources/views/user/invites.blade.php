            ...
            <tbody>
                @foreach ($invitations as $invitation)
                    <tr>
                        ...
                        <td>
                            {{ \App\Enums\UserRole::getLabel($invitation->role) }}
                        </td>
                        <td data-order="{{ $invitation->updated_at }}">
                            @date(['datetime' => $invitation->updated_at])
                        </td>
                        <td>
                            <a href="{{ route('user.invite.retry', $invitation->invitation) }}" class="btn btn-sm btn-danger d-block resend-link"
                                data-buttontext="{{ __('actions.resend') }}" data-buttoncolor="danger">
